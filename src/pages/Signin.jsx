...
export default function Signin() {
  ...
  const [checked, setChecked] = useState(localStorage.getItem("hulabapps-remember") ? true : false);
  ...
  const handleSignin = async (e) => {
    ...
    if (checked) {
      localStorage.setItem("hulabapps-remember", `${username} ${password}`);
    } else {
      localStorage.removeItem("hulabapps-remember");
    }
  ...
  useEffect(() => {
    const rememberMe = localStorage.getItem("hulabapps-remember");
